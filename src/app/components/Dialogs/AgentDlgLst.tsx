...
export default function Dialog({ title, titleName, updateTitleName, dataList, onClose, onOk, children }: Props) {
    ...
    const clickOk = () => {
        onOk()
        alert("AgentDlgLst.txt: OK was Clicked")
        closeDialog()
    }
    ...
    //     ? (
            const dialog = (
                <dialog id="AgentDialogList" ref={dialogRef} className="fixed top-50 left-50 -translate-x-50 -translate-y-50 z-10  rounded-xl backdrop:bg-gray-800/50">
